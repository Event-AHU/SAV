        ...
        if data_tag == 'sam_mul':
            ...
            if self.use_custom_bbox:
                ...
                for data_sample in data_samples:
                    ...
                    print("Number of instances:", len(data_sample.gt_instances))
                    print("Labels:", data_sample.gt_instances.labels)
                    
                    gt_instances = data_sample.gt_instances
                    if training:
                        point_coords = get_random_points(gt_instances, device=device)
                        gt_instances.point_coords = point_coords
                        print("\nAfter processing:")
                        print("Number of instances:", len(gt_instances))
                        print("Labels:", gt_instances.labels)
                        print("Point coords shape:", point_coords.shape)
                    else:
                        raise NotImplementedError
                        
                    gt_instances.bp = torch.zeros(len(gt_instances), device=device)
                    data_sample.gt_instances = gt_instances
