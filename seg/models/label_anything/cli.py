from seg.models.label_anything.experiment.experiment import (
...
import click
from seg.models.label_anything.experiment.pretraining import main as exe_pretrain_pe
...
def generate_embeddings(
    ...
    if huggingface:
        from seg.models.label_anything.preprocess import preprocess_images_to_embeddings_huggingface
        ...
        from seg.models.label_anything.preprocess import preprocess_images_to_embeddings
...
def generate_feature_pyramids(
    ...
    from seg.models.label_anything.preprocess import preprocess_images_to_feature_pyramids
...
def generate_gt(dataset_name, anns_path, outfolder):
    from seg.models.label_anything.preprocess import generate_ground_truths
...
def preprocess_clip(parameters):
    from seg.models.label_anything.preprocess_clip import main as exe_clip_preprocess
...
def preprocess_voc(input_folder):
    from seg.models.label_anything.data.voc12 import preprocess_voc as preprocess_voc_fn
...
def rename_coco20i_json_cli(instances_path):
    from seg.models.label_anything.preprocess import rename_coco20i_json
